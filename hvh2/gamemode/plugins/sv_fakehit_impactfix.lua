/*
	...
	https://github.com/wrefgtzweve/blood-fix
...
local function playEffects( ent, data )
	if !HVH_CONFIG.HideFakeHits then return end
    if not ( ent:IsPlayer() or ent:IsNPC() or ent:IsNextBot() or ent:IsBot() ) or not isBulletDamage( data ) then return end
